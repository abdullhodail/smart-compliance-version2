        ...
        <div className="space-y-8">
          ...
          <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
            ...
            <div className="space-y-3">
               <button className="w-full p-4 rounded-xl border-2 border-primary text-primary text-center text-sm font-black hover:bg-primary/5 transition-all">
                  عرض خطة العمل
               </button>
               <button className="w-full p-4 rounded-xl bg-primary text-white text-center text-sm font-black hover:bg-primary/90 transition-all">
                  ترقية للحصول على التقرير الكامل
               </button>
            </div>
          </div>
        </div>
